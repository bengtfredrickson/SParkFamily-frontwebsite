...
$(function () {
  ...
  // dark light sidebar button setting
   $(".sidebar-color li").on("click", function () {
    ...
    $(".sidebar-color li").removeClass("active"), selectedTheme.addClass("active");
    $(".sidebar-color li.active").data("theme");

    bodytag.removeClass(prevTheme+"-sidebar");
    bodytag.addClass($(this).attr("title")+"-sidebar");
